(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Demis Russo'))
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/, (a) => {
    ...
    */
    ...
    console.log(text.replace(/13 de junho de 1804/, '13/' + getMonthNumber('Junho') + '/1804'))
    ...
    */
    ...
    var regexDate = /(\d\d) de (junho|julho) de (18\d\d)/g
